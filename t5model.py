...
if __name__ == '__main__':
    ...
    # print(model_in['input_ids'].shape, model_in['input_ids'])
    print(model_in["input_ids"].shape, model_in["attention_mask"].shape, model_labels['input_ids'].shape)
    results = model.forward(model_in["input_ids"], model_in["attention_mask"], model_labels['input_ids'])
    # print(model.eval_forward(model_in["input_ids"], model_in["attention_mask"]))
